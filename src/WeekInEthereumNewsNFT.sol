...
contract WeekInEthereumNewsNFT is ERC721, ERC721Consecutive, Colours, Ownable {
    /// ERRORS
...
1676678400	
    ...
    function _generateDescription(uint256 tokenId) internal view returns (string memory) {
        return string.concat(name(), ": ", _generateIssueDate(tokenId), ". #", Strings.toString(tokenId), ". ", _generateIssueUrl(tokenId));
    }
    ...
    function _generateSVG(uint256 tokenId) internal view returns (string memory) {
        ...
        string memory svg = string.concat(
            ...
            "</g>" 
              ...
              '<g class="wienText">'
    '<text x="50" y="385" class="large">Week in Ethereum News</text>'
    '<text x="50" y="405" class="medium">',
            _generateIssueDate(tokenId),
            '</text>'
    '<text x="50" y="445" class="small">',
            _generateIssueUrl(tokenId),
            '</text>'
    '<text x="50" y="460" class="small">#',
